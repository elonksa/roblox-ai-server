...
app.post('/generate-avatar-art', async (req, res) => {
    ...
    try {
        ...
        // 3. تجهيز بيانات الرفع للـ Open Cloud بالطريقة الرسمية الصحيحة
        const boundary = '----WebKitFormBoundary7MA4YWxkTrZu0gW';
        let payload = `--${boundary}\r\n`;
        payload += `Content-Disposition: form-data; name="request"\r\n\r\n`;
        
        // 🚀 تم تصحيح الـ creationContext ليطابق هيكل روبلوكس الإجباري الجديد للـ API Keys
        payload += JSON.stringify({
            ...
            creationContext: {
                creator: {
                    userId: String(userId) // يرفع الـ Decal لصالح اللاعب الفعلي المرسبن
                }
            }
        }) + `\r\n`;
